...
>>>>>>> 6eec0fc7ba72e11e7493637950183fe7ca785366
        ...
        popupmenu.add_command(label="Set as Observable"+label_Obs, command=lambda: self.table.setCurrentEventAsObservable())
        popupmenu.add_command(label="Set as Unobservable"+label_Unobs, command=lambda: self.table.setCurrentEventAsUnobservable())
        popupmenu.add_command(label="Set as Controllable"+label_Contr, command=lambda: self.table.setCurrentEventAsControllable())
