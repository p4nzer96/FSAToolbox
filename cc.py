    ...
    while(len(Xnew)>0):
        ...
        for event in CC.E:
            ...
            if(event in G0.E and event not in G1.E): #private to G0
                ...
                if(stepBystep): print("Synchronized", end='->')
                ...
                if(not transG0.empty and not transG1.empty):
                    for inx,el0 in transG0.iterrows():
                        for jnx,el1 in transG1.iterrows():
                            if(stepBystep): print("["+el0['start'].label+" "+el0['transition'].label+" "+el0['end'].label,end=" , ")
                            if(stepBystep): print(el1['start'].label+" "+el1['transition'].label+" "+el1['end'].label+"]")
